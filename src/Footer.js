    ...
    <footer style={footerStyle}>
      <div style={containerStyle}>
        ...
        <div style={infoStyle}>
          ...
          <ul style={listStyle}>
            <div style={{ display: 'flex', marginLeft: '16rem', gap: '0.6rem' }}>
              <li style={{ marginLeft: '7rem' }}>
                <Link to="https://web.facebook.com/?_rdc=1&_rdr" style={{ color: 'white' }}>
                  <i className="fa fa-facebook-official" aria-hidden="true" style={{ color: 'white' }}></i>
                </Link>
              </li>
              <li>
